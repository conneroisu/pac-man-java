...
public final class MazeNavigationTest {
  ...
  public static void main(final String[] args) {
    ...
    if (Logger.isInfoEnabled()) {
      Logger.info("=== MAZE NAVIGATION TEST ===\n");
    }
    ...
    if (Logger.isInfoEnabled()) {
      Logger.info("=== CHASE MODE NAVIGATION TEST ===");
    }
   ...
   */
  private static void testChaseNavigation(
      final Actor ghost, final Descriptor desc, final int steps) {
    // Set ghost to CHASE mode
    ghost.setMode(Mode.CHASE, desc);

    if (Logger.isInfoEnabled()) {
      Logger.info("Pacman location: " + desc.getPlayerLocation());
      Logger.info(
   ...
   * @param steps Number of update steps to simulate
   */
  private static void testScatterNavigation(
      final Actor ghost, final Descriptor desc, final int steps) {
   ...
   * @param steps Number of update steps to simulate
   */
  private static void testFrightenedNavigation(
      final Actor ghost, final Descriptor desc, final int steps) {
