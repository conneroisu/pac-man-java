...
/**
 * Pinky (Pink Ghost) implementation. Personality: Ambusher Target: 4 tiles ahead of Pac-Man's
 * current position and direction Strategy: Attempts to position ahead of Pac-Man to trap him from
 * the front Note: Due to a bug in the original game, when Pac-Man faces upward, Pinky targets 4
 * tiles up and 4 tiles left of Pac-Man
 */
public final class Pinky extends ActorImpl {
  ...
  /**
   * Gets the target location based on the current mode. When in CHASE mode, targets 4 tiles ahead
   * of Pac-Man.
   *
