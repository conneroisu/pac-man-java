 ...
 * Personality: Unpredictable, wild card
 * Target: Complex calculation using both Pac-Man and Blinky
 * Strategy: 
 * 1. Identify a point 2 tiles ahead of Pac-Man
...
public final class Inky extends ActorImpl {
   ...
   * When in CHASE mode, uses a complex vector calculation based on
   * both Pac-Man's and Blinky's positions.
   *
